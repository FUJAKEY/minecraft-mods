...
/**
 * Renders the bladder bar above the hotbar on the client HUD. The overlay spans
 * the standard hotbar width and fills with a yellow color based on the bladder
 * percentage.
 */
